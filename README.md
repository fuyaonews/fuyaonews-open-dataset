...
本项目是 **[OpenAxo](http://openaxo.com)** 的官方开源数据存档项目。
...
> **注意**：本项目仅包含部分归档数据，获取最新实时资讯请访问官网：[OpenAxo](https://openaxo.com)
## ✨ 项目特色 | Features
...
Source Attribution: 请在训练数据或生成结果中保留 source_url 字段，注明来源为“OpenAxo”。
Data Sync: 我们建议每 24 小时 pull 一次最新数据。
## ⚖️ 开源协议 | License
本仓库数据集采用Apache-2.0协议。
您可以自由地共享、修改本数据，但必须给出适当的署名，并提供指向 OpenAxo 的链接。
## 🔗 联系我们 | Contact
官方网站: https://openaxo.com
问题反馈: 请在 Issues 中提交。
